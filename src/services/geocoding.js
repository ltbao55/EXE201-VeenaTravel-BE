...
class GeocodingService {
  ...
  //   if (!this.apiKey) {
  //     console.warn('Mapbox Access Token is not configured. Please set MAPBOX_ACCESS_TOKEN environment variable.');
  //   }
  //   this.geocodingClient = mbxGeocoding({ accessToken: this.apiKey });
  // }
